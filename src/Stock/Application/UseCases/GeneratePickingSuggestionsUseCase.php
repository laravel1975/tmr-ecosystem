...
class GeneratePickingSuggestionsUseCase
{
    ...
    public function handle(string $pickingSlipId): void
    {
        ...
        foreach ($pickingSlip->items as $item) {
            $itemsToPlan[] = [
                'product_id' => $item->item_id, // หรือ product_id ตาม Database จริง
